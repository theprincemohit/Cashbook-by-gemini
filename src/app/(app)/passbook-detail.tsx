...
const styles = StyleSheet.create({
  ...
  txnIconText: { fontSize: 14, fontWeight: '700' },
  txnInfo: { flex: 1 },
  txnRemark: {
    fontSize: AppFontSizes.sm + 1,
    fontWeight: '600',
  ...
  txnDate: { fontSize: 11, color: AppColors.textMuted },
  txnContact: { fontSize: 11, color: AppColors.textSecondary },
  txnRight: { alignItems: 'flex-end', marginLeft: AppSpacing.sm },
  txnAmount: { fontSize: AppFontSizes.sm + 1, fontWeight: '800' },
  txnReceipt: { fontSize: 13, marginTop: 1 },
  // Empty
  emptyState: {
    backgroundColor: AppColors.bgCard,
